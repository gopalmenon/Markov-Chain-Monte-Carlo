...
\item[2(d)] The Monte Carlo estimate of posterior predictive probability of the label was computed by first doing a dot product of each $\beta$ with the test data and then averaging it out for each data point. A value of $0.5$ and above was classified as Versicolor. 
